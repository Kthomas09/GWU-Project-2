...
#contributions_20 =  contributions_2016.drop(contributions_2016.index[52])


# In[20]:


contributions_2018.head(50)
...
contributions_2018['State'] = renamedState
contributions_2018['Party'] = party
contributions_2018['Name'] = cleanedName
...
contributions_2018 = contributions_2018[['Name', 'State', 'Party', 'Total_Raised']]
...
contributions_2018.to_csv('contributions_2016.csv', index = False)
